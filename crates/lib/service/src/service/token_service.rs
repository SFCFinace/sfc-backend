...
impl TokenService {
    ...
    pub async fn create_token_batch(&self, request: CreateTokenBatchRequest) -> Result<String, ServiceError> {
        ...
        //     ServiceError::InternalError(format!("Invalid invoice ID this: {}", e))
        // })?;
        ...
        let maturity_date = DateTime::now();
        ...
        let token_market = TokenMarket {
            ...
            creditor_address: "creditor.wallet_address.clone()".to_string(),
            debtor_address: "debtor.wallet_address.clone()".to_string(),
